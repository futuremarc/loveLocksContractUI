...
class LockPreview extends Component {
  ...
  render() {
    ...
    let nameStyle, crossStyle;

    currentLock.personA = cleanStr(currentLock.personA)
    currentLock.personB = cleanStr(currentLock.personB)
    ...
    if (currentLock.personA.length + currentLock.personB.length > 19){
      ...
      <div className="preview-lock" style={style}>
        <div className="lock" style={{backgroundColor:currentLock.color}}>
          <div className="preview-lock-body">
            <div className={nameStyle}>{currentLock.personA}</div><div className={crossStyle}>×</div><div className={nameStyle}>{currentLock.personB}</div>
