      ...
      let getMain = new Promise((resolve, reject)=>{
        miniToken.getLoveLocks().then((data)=>{
          ...
          colors.map((item,index)=>{
            colors[index] = cleanStr(web3.toAscii(item));
          })
          personsA.map((item,index)=>{
            personsA[index] = cleanStr(web3.toAscii(item));
          })
          personsB.map((item,index)=>{
            personsB[index] = cleanStr(web3.toAscii(item));
          })
      ...
      let getMsgs = new Promise((resolve, reject)=>{
        ...
        miniToken.getLoveLockMsgs().then((data)=>{
          ...
          msgs1.map((item,index)=>{
            msgs1[index] = cleanStr(web3.toAscii(item));
          })
          msgs2.map((item,index)=>{
            msgs2[index] = cleanStr(web3.toAscii(item));
          })
          msgs3.map((item,index)=>{
            msgs3[index] = cleanStr(web3.toAscii(item));
          })
          msgs4.map((item,index)=>{
            msgs4[index] = cleanStr(web3.toAscii(item));
          })
